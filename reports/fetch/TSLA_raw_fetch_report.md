...
Generated 2026-08-27 22:21 UTC from 14,974 raw articles.
...
- **A repeated, flat monthly count.** If several months show close to the same article count despite covering different numbers of active days, that's the truncation signature -- the call is hitting a ceiling, not describing real volume. This corpus's monthly counts run from 17 to 2,036; genuine variation across that range is the healthy sign, a tight repeated band is not.
