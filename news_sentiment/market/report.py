...
from news_sentiment.config import MARKET_INDEX, report_dir, report_figures_dir
...
from news_sentiment.market import labels as labels_module
...
def write_market_report(final: pd.DataFrame, ticker: str, n_articles: int, path=None):
    ...
    md = [
        ...
        (
            ...
            "it stood at publication. Produced by `news_sentiment.market.run_pipeline`, which "
