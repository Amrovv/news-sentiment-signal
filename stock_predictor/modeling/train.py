...
Run with `python -m stock_predictor.modeling.train`. Nothing runs on import.
"""
...
from stock_predictor.config import MODELS_DIR, REPORTS_DIR, report_dir
from stock_predictor.market.evaluate import fit_final_model
